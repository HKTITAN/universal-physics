...
Grading instrument inherited from [2026-06-08-iter3-encode-vs-generate-criterion.md](2026-06-08-iter3-encode-vs-generate-criterion.md) (g₁–g₇, n₁–n₃, Δ_geo). Carrier object and the located commutant-gap residual inherited from [2026-06-10-iter9-carrier-naturality.md](2026-06-10-iter9-carrier-naturality.md), [2026-06-10-iter10-carrier-in-the-gap.md](2026-06-10-iter10-carrier-in-the-gap.md), and [2026-06-10-iter11-carrier-bicentralizer.md](2026-06-10-iter11-carrier-bicentralizer.md). Prior closures not relitigated.
...
## See also
- [../CONCLUSION.md](../CONCLUSION.md) §§4, 5, 8 — the hedge and the carrier gate
- [../HYPOTHESES.md](../HYPOTHESES.md) — HYP-CKV-VACUITY, HYP-FACTORIZATION-IS-GEOMETRY, HYP-ENCODING-SCREEN
- [2026-06-10-iter11-carrier-bicentralizer.md](2026-06-10-iter11-carrier-bicentralizer.md) — the iter-11 A1 note + binding referee corrections this track discharges (subquestion #1)
- [2026-06-10-iter9-carrier-naturality.md](2026-06-10-iter9-carrier-naturality.md) — Lemma N1/N2, the boost-no-fixed-locus engine that actually closes the BW-net horn
- [2026-06-10-iter10-carrier-in-the-gap.md](2026-06-10-iter10-carrier-in-the-gap.md) — the centralizer carrier sgn(h) and the residual sliver
- [../domains/mathematics.md](../domains/mathematics.md) — Tomita-Takesaki, modular centralizer, (relative) bicentralizer, injective III₁
