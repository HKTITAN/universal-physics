...
### OPEN_PROBLEMS.md — append after the "## Iteration 9 progress (2026-06-10)" block (before its trailing `---`/Status summary):
...
### HYPOTHESES.md — append after the "## Iteration 9 refinements (2026-06-10)" block (before its trailing `---`/See also):
