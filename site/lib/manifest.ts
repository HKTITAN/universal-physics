...
export const CHAPTERS: ManualChapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        num: "13.66",
        slug: "2026-06-19-iter14-D1-carrier-signature-assault",
        title: "Assault on Pillar 1 — Signature-as-Output (Held)",
        file: "notes/2026-06-19-iter14-D1-carrier-signature-assault.md",
        group: "Iteration 14 — 2026-06-19 · the verdict surviving its maximal adversarial assault",
      },
      {
        num: "13.67",
        slug: "2026-06-19-iter14-D2-no-test-assault",
        title: "Assault on Pillar 2 — A Distinguishing Test (Held)",
        file: "notes/2026-06-19-iter14-D2-no-test-assault.md",
        group: "Iteration 14 — 2026-06-19 · the verdict surviving its maximal adversarial assault",
      },
      {
        num: "13.68",
        slug: "2026-06-19-iter14-D3-saturation-assault",
        title: "Assault on Pillar 3 — A Missed Lever (Held)",
        file: "notes/2026-06-19-iter14-D3-saturation-assault.md",
        group: "Iteration 14 — 2026-06-19 · the verdict surviving its maximal adversarial assault",
      },
      {
        num: "13.69",
        slug: "2026-06-19-iter14-synthesis",
        title: "Iteration-14 Synthesis — The Verdict Survives Its Strongest Attack",
        file: "notes/2026-06-19-iter14-synthesis.md",
        group: "Iteration 14 — 2026-06-19 · the verdict surviving its maximal adversarial assault",
      },
      {
        num: "13.70",
        slug: "2026-06-19-iter15-carrier-problem-dossier",
        title: "The Carrier Problem, Posed — An Open-Problem Dossier for External Solvers",
        file: "notes/2026-06-19-iter15-carrier-problem-dossier.md",
        group: "Iteration 15 — 2026-06-19 · the open gate under un-tried mathematics, posed for external resolution",
      },
      {
        num: "13.71",
        slug: "2026-06-19-iter15-E1-factorization-functorial",
        title: "Factorization Algebras / Functorial QFT (Reproduces the Screen)",
        file: "notes/2026-06-19-iter15-E1-factorization-functorial.md",
        group: "Iteration 15 — 2026-06-19 · the open gate under un-tried mathematics, posed for external resolution",
      },
      {
        num: "13.72",
        slug: "2026-06-19-iter15-E2-index-ktheory-coarse",
        title: "Index Theory / K-Theory / Coarse Geometry (Reproduces the Screen)",
        file: "notes/2026-06-19-iter15-E2-index-ktheory-coarse.md",
        group: "Iteration 15 — 2026-06-19 · the open gate under un-tried mathematics, posed for external resolution",
      },
      {
        num: "13.73",
        slug: "2026-06-19-iter15-E3-higher-categorical",
        title: "Higher-Categorical / Homotopical AQFT (Reproduces the Screen)",
      ...
      {
        num: "13.75",
        slug: "2026-07-02-measurement-problem-operationalized",
        title: "R1 Status Refresh — The Measurement Problem, Operationalized (LF Theorems + Collapse Bounds)",
        file: "notes/2026-07-02-measurement-problem-operationalized.md",
        group: "Watch mode — post-saturation · dated external-input sweeps (not analytical iterations)",
      },
      {
        num: "13.76",
        slug: "2026-07-02-r1-bh-information-status",
        title: "R1 Status Refresh — Black-Hole Information (Two-Leg Status)",
        file: "notes/2026-07-02-r1-bh-information-status.md",
        group: "Watch mode — post-saturation · dated external-input sweeps (not analytical iterations)",
      },
      {
        num: "13.77",
        slug: "2026-07-03-iter16-G1-multiwedge-naturality",
        title: "G1 — The Multi-Wedge Naturality Assault: Lemma G and the (E_O) Residual",
        file: "notes/2026-07-03-iter16-G1-multiwedge-naturality.md",
      ...
      {
        num: "13.78",
        slug: "2026-07-03-iter16-G2-constructive-carrier",
        title: "G2 — Three Untried Carrier Constructions, Executed and Blocked",
        file: "notes/2026-07-03-iter16-G2-constructive-carrier.md",
        group: "Iteration 16 — 2026-07-03 · the clock-(1) iteration: the multi-wedge closure and the first hedge advance since iteration 9",
      },
      {
        num: "13.79",
        slug: "2026-07-03-iter16-G3-marrakchi-transfer",
        title: "G3 — The Marrakchi Transfer Audit: Expectation Is Definitional; the Target Was Ill-Posed",
        file: "notes/2026-07-03-iter16-G3-marrakchi-transfer.md",
        group: "Iteration 16 — 2026-07-03 · the clock-(1) iteration: the multi-wedge closure and the first hedge advance since iteration 9",
      },
      {
        num: "13.80",
        slug: "2026-07-03-iter16-G4-untried-readouts",
        title: "G4 — The Untried-Readout Sweep: Seven Screens Reproduced, One Definability Lever (DCNG)",
        file: "notes/2026-07-03-iter16-G4-untried-readouts.md",
        group: "Iteration 16 — 2026-07-03 · the clock-(1) iteration: the multi-wedge closure and the first hedge advance since iteration 9",
      },
      {
        num: "13.81",
        slug: "2026-07-03-iter16-synthesis",
        title: "Iteration-16 Synthesis — HYP-CKV-VACUITY-R7 and the (E_O) Residual",
      ...
      {
        num: "13.92",
        slug: "2026-07-12-iter25-normal-form",
        title: "Iteration-25 Synthesis — The Normal Form: The Gate Becomes a Scalar Imaginary-Flux Problem; The Crux Relocated to LEM-SEAM",
