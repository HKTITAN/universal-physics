    ...
    <div className="cover">
      ...
      <section className="cover-plate" aria-labelledby="cover-title">
        <p className="cover-kicker">
          <span>Technical reference manual · Revision 22 · 2026-07-11</span>
        ...
        <p className="cover-subtitle">
          A twenty-two-iteration, adversarially-refereed research program toward a universal theory of
        ...
        <dl className="cover-stats">
          <div>
            <dt>Iterations</dt>
            <dd>
              22 <span className="unit">(terminal saturation)</span>
            </dd>
          </div>
          <div>
          ...
          <div>
            <dt>Verdict</dt>
            <dd>
              <span className="unit">unchanged 21 iters:</span> not-yet-physics
            </dd>
          </div>
        </dl>
      </section>
      ...
      <blockquote className="verdict-excerpt">
        ...
        <p style={{ fontFamily: "var(--mono)", fontSize: "0.72rem", color: "var(--ink-500)" }}>
          Condensed; the full paragraph, with its hedges and its twenty-one-iteration stability record,
