...
**Status:** Terminal analytical saturation — consolidation + watch-mode (clock-gated; iteration 16 advanced the hedge to R7; iteration 17 attacked the residual (E_O) directly — reduced the free-field case to a one-particle spectral question, closed three routes and the disproof, hedge held at R7; the no-go rests on {n₁, (E_O)}).
